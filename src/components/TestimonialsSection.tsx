...
const testimonials = [
  {
    ...
    content: "Сотрудничество превзошло все наши ожидания. За 3 месяца получили 5400 лидов, конверсия в продажи составила 7%. Окупили вложения уже через 40 дней.",
    avatar: "https://i.pravatar.cc/100?img=1"
  },
  {
    name: "Марина Ковалёва",
    role: "Директор по маркетингу, АвтоСервисГрупп",
    content: "Скептически относились к предложениям по лидгену, но решили попробовать. Результат: стабильный поток клиентов и увеличение прибыли на 38% за квартал.",
    avatar: "https://i.pravatar.cc/100?img=5"
  },
  {
    name: "Дмитрий Верхов",
    role: "Владелец, СтройМаркет",
    content: "Подписали договор на 10000 лидов, получаем партиями по 1000. Качество контактов на высоте, менеджеры довольны, что не приходится "пробивать стену" при общении.",
    avatar: "https://i.pravatar.cc/100?img=3"
  },
  {
    name: "Елена Миронова",
    role: "Руководитель отдела продаж, МедТехника",
    content: "Особенно ценим прозрачность в работе и детальную аналитику. Мы всегда видим, откуда пришел лид и как он взаимодействовал с нами. Это позволяет оптимизировать воронку.",
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Более 150 компаний уже получили измеримые результаты благодаря нашему сервису лидогенерации
          </p>
        </div>
                ...
                <CarouselItem key={index} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                  <div className="neon-card p-6 rounded-lg h-full flex flex-col">
                    ...
                    <div className="mb-4 text-gray-300">
                      <Icon name="Quote" className="h-5 w-5 text-matrix-purple mb-2" />
        ...
        <div className={`mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
          <div className="neon-card rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-matrix-purple mb-2">150+</div>
            <p className="text-gray-400">Довольных клиентов</p>
          </div>
          <div className="neon-card rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-matrix-purple mb-2">1M+</div>
            <p className="text-gray-400">Лидов сгенерировано</p>
          </div>
          <div className="neon-card rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-matrix-purple mb-2">98%</div>
